...
const inputStyle =
  "bg-white ml-2 border border-slate-300 py-2 px-2 shadow-sm focus:outline-none focus:border-aliceblue focus:black focus:ring-2 rounded";
const radioStyle =
...
const ContactForm = () => {
  ...
  return (
    <div className="bg-darkseagreen p-8 drop-shadow-lg max-w-screen-sm max-h-80">
      ...
      >
        <h2 className="self-center text-2xl font-cursive ">
          Add Contect
        </h2>
        <div>
        ...
        <button
          type="submit"
          className="w-3/4 bg-black text-white p-2 self-center rounded "
        >
          Save Number
        </button>
      </form>
